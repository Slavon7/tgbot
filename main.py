...
def mess(message, btn1=None):
	...
	if get_message_bot == "⬅ на початок":
		...
		btn3 = types.KeyboardButton('🧮 Розрахунок конкурсного балу')
		...
		final_message = "✅ Участь в проекті «Innovation Campus»\n" \
						...
						"✅ Можливість долучатись до програм міжнародної академічної мобільності та отримання паралельно магістерських дипломів українського та  іноземного зразків"
		...
		bot.send_photo(message.chat.id, photo)
		final_message = "Приклад заповнення мотиваційного листа"
		...
		p = open("media/countbudgeting2.png", "rb")
		bot.send_photo(message.chat.id, p)
		p.close()
		final_message = "Кількість  місць"
